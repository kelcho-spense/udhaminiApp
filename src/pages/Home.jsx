    ...
    <div className='justify-center align-center'>
      <div className="carousel w-full max-h-full">
        <div id="1" className="carousel-item relative w-full">
          <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
              <img src={slider2} className="max-w-xl rounded-lg shadow-2xl" />
              <div>
        ...
        <div id="2" className="carousel-item relative w-full">
          <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
              <img src={slider3} className="max-w-xl rounded-lg shadow-2xl" />
              <div>
        ...
        <div id="3" className="carousel-item relative w-full">
          <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
              <img src={slider1} className="max-w-sm rounded-lg shadow-2xl" />
              <div>
        ...
        <div id="4" className="carousel-item relative w-full">
          <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
              <img src={slider4} className="max-w-sm h-sm rounded-lg shadow-2xl" />
              <div>
